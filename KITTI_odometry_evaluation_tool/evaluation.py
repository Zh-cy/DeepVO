...
class kittiOdomEval():
    def __init__(self, config):
        ...
        self.result_dir = 'path to your KITTI_odometry_evaluation_tool folder' + config.folder
        # eg. self.result_dir = '/home/zhangsan/KITTI_odometry_evaluation_tool/' + config.folder
        self.eval_seqs  = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt_dir', type=str,
                        default='path to your KITTI_odometry_evaluation_tool folder /ground_truth_pose',
                        help='Directory path of the ground truth odometry')
    # eg: parser.add_argument('--gt_dir',     type=str, default='/home/zhangsan/KITTI_odometry_evaluation_tool/ground_truth_pose',  help='Directory path of the ground truth odometry')
    parser.add_argument('--folder', type=str, help='Directory path of storing the odometry results')
    parser.add_argument('--eva_seqs',   type=str, default='00_pred,01_pred,02_pred,03_pred,04_pred,05_pred,06_pred,07_pred,08_pred,09_pred,10_pred', help='The sequences to be evaluated') 
